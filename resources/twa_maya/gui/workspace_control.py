...
class WorkspaceControl(object):
    """
    A Workspace control class. Allows docking of maya widgets and running ui scripts
    """
...
class SampleMayaUI(QtWidgets.QWidget):
    """
    A generick maya ui(QWidget) implementation that uses workspace control.
    """

    WINDOW_TITLE = "SampleMayaUI"
    ...
    def __init__(self):
        super(SampleMayaUI, self).__init__()
